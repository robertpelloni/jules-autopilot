...
export declare function evaluatePlanRisk(planText: string, provider: string, apiKey: string, model: string): Promise<number>;
/**
...
export declare function decideNextAction(provider: string, apiKey: string, model: string, context: string, history?: {
    role: string;
    content: string;
}[]): Promise<string>;
