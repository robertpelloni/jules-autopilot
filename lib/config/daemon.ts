...
export const DAEMON_HTTP_BASE_URL = (import.meta as any).env?.VITE_JULES_API_BASE_URL || '/api';

// WebSocket URL must be absolute in the browser
export const DAEMON_WS_URL = (import.meta as any).env?.VITE_JULES_WS_URL || 
  (isBrowser 
