...
- [ ] **Go Backend Parity Pass #4:** Port `handleCheckIssues` and replace the current heuristic-only Go approval escalation path with full council-debate/provider parity.
