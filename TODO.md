...
- [ ] **Go Backend Parity Pass #22:** Continue auditing for any remaining residual Bun-only backend behavior and consider richer observability/dashboard surfaces beyond the current health dashboard and metrics preview.
