...
- [ ] **Go Backend Parity Pass #15:** Continue tightening Go-side provider abstractions and audit whether any remaining non-core utility surfaces still need Go-native API coverage.
