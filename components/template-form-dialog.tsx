    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] border-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
        <DialogHeader>
          ...
          <DialogDescription>
            {template ? 'Update the details for this session template.' : 'Configure a new template for quick session creation.'}
          </DialogDescription>
        </DialogHeader>

        <form id="template-form" onSubmit={handleSubmit} className="space-y-4 pt-2">
