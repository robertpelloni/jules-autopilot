          ...
          <div className="relative">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-white transition-colors p-0.5 rounded-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-purple-500"
              >
                <X className="h-3 w-3" />
              </button>
            )}
