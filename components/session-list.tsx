          ...
          <div className="relative group">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2 top-1/2 h-4 w-4 -translate-y-1/2 rounded-sm text-muted-foreground hover:text-white hover:bg-white/10 flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-purple-500/50"
              >
                <X className="h-3 w-3" />
              </button>
            )}
