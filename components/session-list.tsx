          ...
          <div className="relative">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-white transition-colors outline-none focus-visible:ring-1 focus-visible:ring-purple-500/50 rounded-sm"
